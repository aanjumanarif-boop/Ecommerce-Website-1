				...
				<div class="product-items-wrapper">
					<div class="product__item-outer">
						...
						<div class="product__item-info-outer">
							<a href="{{url('/category-products')}}" class="product__item-name">
								Test Product
							</a>
			...
			<div class="container">
				...
				<div class="product-items-wrapper">
					<div class="product__item-outer">
						...
						<div class="product__item-info-outer">
							<a href="{{url('/prodect-details')}}" class="product__item-name">
								Test Product
							</a>
							<div class="product__item-price-outer">
								<div class="product__item-discount-price">
					...
					<div class="product__item-outer">
						<div class="product__item-image-outer">
							<a href="{{url('/prodect-details')}}" class="product__item-image-inner">
								<img src="{{asset('frontend/assets/images/product.png')}}" alt="Product Image" />
							</a>
							<div class="product__item-add-cart-btn-outer">
								<a href="#" class="product__item-add-cart-btn-inner">
